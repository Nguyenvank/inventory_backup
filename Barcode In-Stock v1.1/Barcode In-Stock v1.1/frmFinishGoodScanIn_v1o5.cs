...
{
    public partial class frmFinishGoodScanIn_v1o5 : Form
    {
        ...
        public frmFinishGoodScanIn_v1o5()
        {
            InitializeComponent();
        ...
        private void frmFinishGoodScanIn_v1o5_Load(object sender, EventArgs e)
        {
                            ...
                            if (ds.Tables[0].Rows.Count == 0)
                            {
                                if (qty != "0")
                                {
                                    ...
                                    if (partName.ToLower().Contains("dispenser"))
                                    {
                                        ...
                                        frmFinishGoodScanIn_v1o5_CheckProof frm = new frmFinishGoodScanIn_v1o5_CheckProof();
