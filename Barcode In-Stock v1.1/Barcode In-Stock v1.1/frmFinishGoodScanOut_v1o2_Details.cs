...
{
    public partial class frmFinishGoodScanOut_v1o2_Details : Form
    {
        System.Timers.Timer
        ...
        public frmFinishGoodScanOut_v1o2_Details()
        {
            InitializeComponent();
        }

        public frmFinishGoodScanOut_v1o2_Details(string box_idx,string temper_type)
        {
            InitializeComponent();
        ...
        private void frmFinishGoodScanOut_v1o2_Details_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }

        private void frmFinishGoodScanOut_v1o2_Details_KeyDown(object sender, KeyEventArgs e)
        {
