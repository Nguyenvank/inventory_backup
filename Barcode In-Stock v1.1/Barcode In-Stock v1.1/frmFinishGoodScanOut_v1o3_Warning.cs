...
{
    public partial class frmFinishGoodScanOut_v1o3_Warning : Form
    {
        System.Timers.Timer
        ...
        public frmFinishGoodScanOut_v1o3_Warning()
        {
            InitializeComponent();
        }

        public frmFinishGoodScanOut_v1o3_Warning(byte err_code)
        {
            InitializeComponent();
        ...
        private void frmFinishGoodScanOut_v1o3_Warning_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }
