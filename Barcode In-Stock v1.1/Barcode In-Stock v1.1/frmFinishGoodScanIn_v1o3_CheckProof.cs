...
{
    public partial class frmFinishGoodScanIn_v1o3_CheckProof : Form
    {
        ...
        private void frmFinishGoodScanIn_v1o3_CheckProof_Shown(object sender, EventArgs e)
        {
        ...
        public frmFinishGoodScanIn_v1o3_CheckProof()
        {
            InitializeComponent();
        }

        private void frmFinishGoodScanIn_v1o3_CheckProof_Load(object sender, EventArgs e)
        {
            rdb_Line01.Checked = rdb_Line02.Checked = false;
            rdb_Line01.BackColor = rdb_Line02.BackColor = Color.FromKnownColor(KnownColor.Control);
