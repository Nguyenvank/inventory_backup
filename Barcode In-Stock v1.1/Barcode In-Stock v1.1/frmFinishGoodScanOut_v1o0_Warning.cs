...
{
    public partial class frmFinishGoodScanOut_v1o0_Warning : Form
    {
        System.Timers.Timer
        ...
        public frmFinishGoodScanOut_v1o0_Warning()
        {
            InitializeComponent();
        }

        public frmFinishGoodScanOut_v1o0_Warning(byte err_code)
        {
            InitializeComponent();
        ...
        private void frmFinishGoodScanOut_v1o0_Warning_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }
