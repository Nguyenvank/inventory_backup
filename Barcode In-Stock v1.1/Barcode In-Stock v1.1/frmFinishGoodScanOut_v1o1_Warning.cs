...
{
    public partial class frmFinishGoodScanOut_v1o1_Warning : Form
    {
        System.Timers.Timer
        ...
        public frmFinishGoodScanOut_v1o1_Warning()
        {
            InitializeComponent();
        }

        public frmFinishGoodScanOut_v1o1_Warning(byte err_code)
        {
            InitializeComponent();
        ...
        private void frmFinishGoodScanOut_v1o1_Warning_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }
