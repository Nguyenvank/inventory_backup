...
{
    public partial class frmFinishGoodScanOut_v1o0 : Form
    {
        System.Timers.Timer
        ...
        public frmFinishGoodScanOut_v1o0()
        {
            InitializeComponent();
        ...
        private void frmFinishGoodScanOut_v1o0_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }
        ...
        public void Fnc_Load_Data_Out_Click(DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                frmFinishGoodScanOut_v1o0_Details details = new frmFinishGoodScanOut_v1o0_Details(box_idx, temper_type);
                details.ShowDialog();
            }
        }
        ...
        public void Fnc_Load_Scan_Code()
        {
            try
            {
                ...
                frmFinishGoodScanOut_v1o0_Warning warning;
                ...
                if (code.Length > 0)
                {
                    if (code.Length >= 20)
                    {
                        ...
                        if (bool_valid_form == true && bool_valid_exist == true && bool_valid_rank == true && bool_valid_ready == true)
                        {
                            ...
                            warning = new frmFinishGoodScanOut_v1o0_Warning(msg_code);
                            warning.ShowDialog();
                            return;
                        }
                        else
        ...
        private void frmFinishGoodScanOut_v1o0_FormClosing(object sender, FormClosingEventArgs e)
        {
