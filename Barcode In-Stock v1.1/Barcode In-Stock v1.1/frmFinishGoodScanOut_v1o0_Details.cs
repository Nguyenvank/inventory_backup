...
{
    public partial class frmFinishGoodScanOut_v1o0_Details : Form
    {
        System.Timers.Timer
        ...
        public frmFinishGoodScanOut_v1o0_Details()
        {
            InitializeComponent();
        }

        public frmFinishGoodScanOut_v1o0_Details(string box_idx,string temper_type)
        {
            InitializeComponent();
        ...
        private void frmFinishGoodScanOut_v1o0_Details_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }

        private void frmFinishGoodScanOut_v1o0_Details_KeyDown(object sender, KeyEventArgs e)
        {
