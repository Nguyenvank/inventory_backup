...
{
    public partial class frmFinishGoodScanOut_v1o1 : Form
    {
        System.Timers.Timer
            __timer_main = new System.Timers.Timer(),
            __timer_temp = new System.Timers.Timer(),
            __timer_focus = new System.Timers.Timer();
        ...
        public frmFinishGoodScanOut_v1o1()
        {
            InitializeComponent();
            ...
            //__timer_temp.Interval = 300000; // get signal every 5 mins (300s = 300.000ms)
            __timer_temp.Interval = 60000;
            __timer_temp.Enabled = false;
            __timer_temp.Elapsed += __timer_temp_Elapsed;

            __timer_focus.Interval = 1000;
            __timer_focus.Enabled = false;
            __timer_focus.Elapsed += __timer_focus_Elapsed;
        ...
        public void Fnc_Load_Controls()
        {
            ...
            dgv_list_ready.DataSource = dgv_list_in.DataSource = dgv_list_out.DataSource = null;
        ...
        public void Fnc_Load_Data()
        {
            try
            {
                ...
                __sql = "V2_BASE_WB_Heating_ScanOut_List_SelItem_V1o0";
        ...
        public void Fnc_Load_Data_In()
        {
            try
            {
                ...
                dgv_list_in.Columns[3].FillWeight = 37;      //boxcode
                //dgv_list_in.Columns[4].FillWeight = 5;      //prodId
                dgv_list_in.Columns[5].FillWeight = 20;      //boxpartname
                ...
                dgv_list_in.Columns[16].FillWeight = 20;      //[Heating time]
                ...
                dgv_list_in.Columns[8].Visible = true;
                ...
                cls.fnFormatDatagridview_FullWidth(dgv_list_in, 10, 30);
        ...
        public void Fnc_Load_Data_In_Color()
        {
            try
            {
                ...
                foreach (DataGridViewRow row in dgv_list_in.Rows)
                {
                    ...
                    if (_rank == 1)
                    {
                        row.DefaultCellStyle.BackColor = (_ready == true) ? Color.LightGreen : Color.Gold;
                        row.DefaultCellStyle.ForeColor = Color.Black;
                    }
                    else
                    {
        ...
        public void Fnc_Load_Data_Out()
        {
            try
            {
                ...
                dgv_list_out.Columns[6].FillWeight = 10;      //boxpartno
                dgv_list_out.Columns[7].FillWeight = 5;      //boxquantity
                dgv_list_out.Columns[8].FillWeight = 12;      //IN_Date
                //dgv_list_out.Columns[9].FillWeight = 5;      //box_out
                dgv_list_out.Columns[10].FillWeight = 12;      //box_out_dt
                ...
                dgv_list_out.Columns[8].DefaultCellStyle.Format =
                    dgv_list_out.Columns[10].DefaultCellStyle.Format = "dd/MM/yyyy HH:mm:ss";

                cls.fnFormatDatagridview_FullWidth(dgv_list_out, 10, 30);
        ...
        public void Fnc_Load_Data_Out_Click(DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                frmFinishGoodScanOut_v1o1_Details details = new frmFinishGoodScanOut_v1o1_Details(box_idx, temper_type);
                details.ShowDialog();
            }
        }
        ...
        public void Fnc_Load_Scan_Code()
        {
            try
            {
                ...
                frmFinishGoodScanOut_v1o1_Warning warning;
                ...
                if (code.Length > 0)
                {
                    if (code.Length >= 20)
                    {
                        ...
                        if (bool_valid_form == true && bool_valid_exist == true && bool_valid_rank == true && bool_valid_ready == true)
                        {
                            ...
                            warning = new frmFinishGoodScanOut_v1o1_Warning(msg_code);
                            warning.ShowDialog();
                            return;
                        }
                        else
        ...
        private void __timer_main_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            try
            {
                ...
                //if ((__dt_min == 0 || __dt_min % 5 == 0) && __dt_sec == 2)
                //{
                //    //Fnc_Get_Temper();
                //    Fnc_Get_Temper_Spec();
                //    Fnc_Read_Temper_From_File(__fle_local);
                ...
                //if ((__dt_min == 4 || __dt_min == 14 || __dt_min == 24 || __dt_min == 34 || __dt_min == 44 || __dt_min == 54 || __dt_min == 9 || __dt_min == 19 || __dt_min == 29 || __dt_min == 39 || __dt_min == 49 || __dt_min == 59) && __dt_sec == 58)
                //{
                //    Fnc_Write_Temper_To_DB(__fle_server);
                //}

                if ((__dt_min == 0 || __dt_min % 15 == 0) && __dt_sec == 10)
                {
                    SystemSleepAPI.PreventSleep();
                }
        ...
        private void __timer_temp_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            
        }

        private void __timer_focus_Elapsed(object sender, System.Timers.ElapsedEventArgs e)
        {
            //if (__focus >= 0)
            //{
            //    __focus -= 1;
        ...
        private void frmFinishGoodScanOut_v1o1_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void frmFinishGoodScanOut_v1o1_MouseMove(object sender, MouseEventArgs e)
        {
