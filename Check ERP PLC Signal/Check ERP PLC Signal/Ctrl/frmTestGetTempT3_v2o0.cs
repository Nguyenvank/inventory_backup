...
{
    public partial class frmTestGetTempT3_v2o0 : UserControl
    {

        string _tempData = "";
        int _maxSignal = 40;

        public frmTestGetTempT3_v2o0()
        {
            InitializeComponent();
        }

        private void frmTestGetTempT3_v2o0_Load(object sender, EventArgs e)
        {
            Fnc_Load_Init();
        }
        ...
        {
            string temp = _tempData, temp_Signal = "";
            int temp_Lenth = temp.Length, temp_Start = 0, temp_Step = 4;
