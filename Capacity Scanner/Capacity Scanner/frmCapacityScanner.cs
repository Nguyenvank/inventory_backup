...
{
    public partial class frmCapacityScanner : Form
    {
        ...
        private void txtItemCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (!(sender as TextBox).ContainsFocus)
                    return;
                DisposeTimer();
                timer = new System.Threading.Timer(new TimerCallback(TimerElapsed), (object)null, frmCapacityScanner.VALIDATION_DELAY, frmCapacityScanner.VALIDATION_DELAY);
            }
            catch
            {
