...
{
    public partial class uc_CapacityScanner : UserControl
    {
        ...
        private void frmCapacityScanner_Load(object sender, EventArgs e)
        {
            try
            {
                init();
        ...
        public void fnBindInit()
        {
            try
            {
                ...
                string code01 = "", code02 = "", code03 = "";
                int codeN = 0;
                string sqlInit = "V2o1_BASE_Capacity_Dispenser_Scan_SelItem_Addnew";
        ...
        private void txtItemCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (!(sender as TextBox).ContainsFocus)
                    return;
                DisposeTimer();
                timer = new System.Threading.Timer(new TimerCallback(TimerElapsed), (object)null, uc_CapacityScanner.VALIDATION_DELAY, uc_CapacityScanner.VALIDATION_DELAY);
            }
            catch
            {
        ...
        public void fnCheckAutoNG(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    label9.Text = "ITEM BARCODE (" + String.Format("{0:00}", _counterDis) + ")";
        ...
        public void fnSaveTotal(string barcode)
        {
            try
            {
                ...
                idx = _idx;
                string sql = "V2o1_BASE_Capacity_Dispenser_Scan_AddItem_Addnew";
