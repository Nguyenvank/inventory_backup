...
{
    public partial class uc_CapacityScanner_v2o2 : UserControl

    {
        ...
        public uc_CapacityScanner_v2o2()
        {
            InitializeComponent();
        ...
        private void frmCapacityScanner_v2o2_Load(object sender, EventArgs e)
        {
            try
            {
                init();
        ...
        public void fnBindInit()
        {
            try
            {
                ...
                if (dtInit.Rows.Count > 0)
                {
                    ...
                    if ((code02 != "" && code02 != null) && (code01 != "" && code01 != null))
                    {
                        codeN = 2;
                    }
                    if ((code03 != "" && code03 != null) && (code02 != "" && code02 != null) && (code01 != "" && code01 != null))
                    {
                        codeN = 3;
                    }
                }
        ...
        private void txtItemCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (!(sender as TextBox).ContainsFocus)
                    return;
                DisposeTimer();
                timer = new System.Threading.Timer(new TimerCallback(TimerElapsed), (object)null, uc_CapacityScanner_v2o2.VALIDATION_DELAY, uc_CapacityScanner_v2o2.VALIDATION_DELAY);
            }
            catch
            {
        ...
        public void Fnc_Insert_DB_02(string s)
        {
            int nCode = _codeN;
            try
            {
