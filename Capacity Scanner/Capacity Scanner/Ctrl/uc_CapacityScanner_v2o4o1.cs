...
{
    public partial class uc_CapacityScanner_v2o4o1 : UserControl

    {
        ...
        public uc_CapacityScanner_v2o4o1()
        {
            InitializeComponent();
        ...
        private void txtItemCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (!(sender as TextBox).ContainsFocus)
                    return;
                DisposeTimer();
                timer = new System.Threading.Timer(new TimerCallback(TimerElapsed), (object)null, uc_CapacityScanner_v2o4o1.VALIDATION_DELAY, uc_CapacityScanner_v2o4o1.VALIDATION_DELAY);
            }
            catch
            {
