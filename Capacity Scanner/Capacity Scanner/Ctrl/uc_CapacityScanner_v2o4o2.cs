...
{
    public partial class uc_CapacityScanner_v2o4o2 : UserControl
    {
        Plc _plc;
        CpuType _cpu = CpuType.S71200;
        string _ip = "192.168.0.14";
        short _rack = 0;
        short _slot = 0;
        System.Windows.Forms.Timer _timer = new System.Windows.Forms.Timer();
        bool _readable = false, _wrong = false;
        int _cycle = 1000;

        string _addr_01 = "", _addr_02 = "", _addr_03 = "", _addr_04 = "", _addr_05 = "", _addr_06 = "", _addr_07 = "", _addr_08 = "", _addr_09 = "", _addr_10 = "";
        ...
        System.Windows.Forms.Timer timer_Barcode = new System.Windows.Forms.Timer();
        ...
        string _partcode;
        string _partuph;
        string _partordertime;
        string _partordertotal;
        string _partsubcode;
        string _partsubcode01;
        string _partsubcode02;
        string _partsubcode03;
        int _statusOK;
        int _statusNG;
        int _total;
        Decimal _rate;
        string _nextIdx;
        string _nextPartname;
        string _nextTime;
        string _prevBarcode;
        string _code;
        int _autoNG;
        ...
        public uc_CapacityScanner_v2o4o2()
        {
            InitializeComponent();
            ...
            _ip= ini.GetIniValue("MACHINE", "IP", "192.168.0.14").Trim();
            ...
            timer_Barcode.Interval = 500;
            timer_Barcode.Enabled = true;
            timer_Barcode.Tick += Timer_Barcode_Tick;
        ...
        public void Fnc_Load_PLC_Connect()
        {
            ...
            if (_plc.IsConnected)
            {
                _timer.Interval = _cycle;
                _timer.Enabled = true;
                _timer.Tick += _timer_Tick;
            }
        }

        public void Fnc_Load_PLC_Addr()
        {
            _addr_01 = Properties.Resources.bool_q18_0;     //tin hieu doc dispenser 01
            _addr_02 = Properties.Resources.bool_q18_1;     //tin hieu doc dispenser 02
            _addr_03 = Properties.Resources.bool_q18_2;     //tin hieu sai dispenser 01
            _addr_04 = Properties.Resources.bool_q18_3;     //tin hieu sai dispenser 02
        }

        public void Fnc_Load_Barcode_Readable(string line = "1", bool readable = false)
        {
            if (_plc.IsConnected)
            {
                string addr = "";
                ...
                _plc.Write(addr, readable);
            }
        }

        public void Fnc_Load_Barcode_Wrong(string line="1",bool wrong = false)
        {
            if (_plc.IsConnected)
            {
                string addr = "";
        ...
        private void txtItemCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (!(sender as TextBox).ContainsFocus)
                    return;
                DisposeTimer();
                timer = new System.Threading.Timer(new TimerCallback(TimerElapsed), (object)null, uc_CapacityScanner_v2o4o2.VALIDATION_DELAY, uc_CapacityScanner_v2o4o2.VALIDATION_DELAY);
            }
            catch
            {
                    ...
                    if (nCode > 1)
                    {
                        if (s.Contains(_partsubcode01) && _partsubcode01 != "" || s.Contains(_partsubcode02) && _partsubcode02 != "" || s.Contains(_partsubcode03) && _partsubcode03 != "")
                        {
                            ...
                            if (str != _prevBarcode)
                            {
                                ...
                                //Fnc_Load_Barcode_Readable(lineno, true);
                            }
                            else
                            {
                                NGStatus();
                        ...
                        else
                        {
                            ...
                            //Fnc_Load_Barcode_Wrong(lineno, true);
                        }
                        _total = _statusOK + _statusNG;
                        fnSaveTotal(s);
                    }
