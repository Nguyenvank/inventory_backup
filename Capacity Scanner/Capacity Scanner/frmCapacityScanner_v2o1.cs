...
{
    public partial class frmCapacityScanner_v2o1 : Form

    {
        ...
        public frmCapacityScanner_v2o1()
        {
            InitializeComponent();
        ...
        private void txtItemCode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                if (!(sender as TextBox).ContainsFocus)
                    return;
                DisposeTimer();
                timer = new System.Threading.Timer(new TimerCallback(TimerElapsed), (object)null, frmCapacityScanner_v2o1.VALIDATION_DELAY, frmCapacityScanner_v2o1.VALIDATION_DELAY);
            }
            catch
            {
